authorization do
	role :administrator do	
		has_permission_on :workers, :to => [:index, :show, :lista, :new ,:create,:delete,:pracownik,:szczegoly,:import_render,:import,:import_tn,:import_tc, :import_tt,:import_tdc,:import_rn,:import_rn_finall,:import_workers,:import_stanowiska,:import_jednostki_organizacyjne,:calendar]
		...
		has_permission_on :positions, :to => [:new,:create,:delete,:import]
		...
		has_permission_on :tabelaczasowdostepnychs, :to => [:index,:export,:create,:new,:delete]
		has_permission_on :realizacjanorms, :to => [:index,:export,:create,:new,:delete]
